document.addEventListener("DOMContentLoaded", () => {
    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        activityCard.innerHTML = `
          ...
          <ul>
            ${details.participants.map(participant => `<li class="participant"><span class="email">${participant}</span> <button class="delete-btn" data-activity="${name}" data-email="${participant}" aria-label="Remove participant">✖</button></li>`).join('')}
          </ul>
        `;
      ...
      // delete handler is registered once below
    } catch (error) {
  ...
  // Register delete handler (event delegation)
